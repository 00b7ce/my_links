...
function App() {
    const links = [
        { url: 'https://blog.mekabu.io', title: 'Blog', icon: 'blog-icon.svg' },
        { url: 'https://mkb-toolbox.hateblo.jp', title: 'Blog(old)', icon: 'hatenablog-logo.svg' },
        ...
        { url: 'https://misskey.io/@mkb/', title: '@mkb@misskey.io', icon: 'misskey.svg' },
        // 他のリンクを追加
    ];
